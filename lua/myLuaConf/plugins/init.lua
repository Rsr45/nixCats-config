...
require("lze").load({
    ...
    },
    {
        ...
        keys = {
            { "<C-w>t", "<Cmd><C-U>TmuxNavigateLeft<CR>",     mode = "n", silent = true, noremap = true },
            { "<C-w>r", "<Cmd><C-U>TmuxNavigateDown<CR>",     mode = "n", silent = true, noremap = true },
            { "<C-w>l", "<Cmd><C-U>TmuxNavigateUp<CR>",       mode = "n", silent = true, noremap = true },
            { "<C-w>d", "<Cmd><C-U>TmuxNavigateRight<CR>",    mode = "n", silent = true, noremap = true },

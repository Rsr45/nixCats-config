...
require("lze").load({
    ...
    },
    {
        ...
        keys = {
            { "<C-t>t", "<cmd>TmuxNavigateLeft<CR>",     mode = "n", silent = true, noremap = true },
            { "<C-r>r", "<cmd>TmuxNavigateDown<CR>",     mode = "n", silent = true, noremap = true },
            { "<C-l>l", "<cmd>TmuxNavigateUp<CR>",       mode = "n", silent = true, noremap = true },
            { "<C-d>d", "<cmd>TmuxNavigateRight<CR>",    mode = "n", silent = true, noremap = true },
